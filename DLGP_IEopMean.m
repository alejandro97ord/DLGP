classdef DLGP_IEopMean < matlab.System & matlab.system.mixin.Propagates & matlab.system.mixin.SampleTime & matlab.system.mixin.CustomIcon
    ...
    methods(Access = protected)
        ...
        function [ df] = grad(obj,hyps,model)
            ...
            obj.alpha(1:obj.localCount(model),obj.auxUbic(model)) = Kn\(obj.Y((obj.auxUbic(model)-1)*obj.pts+1:...
                (obj.auxUbic(model)-1)*obj.pts+obj.localCount(model))'-obj.meanFunction(obj.X(:,(obj.auxUbic(model)-1)*obj.pts+1:...
                (obj.auxUbic(model)-1)*obj.pts+obj.localCount(model)))');
        ...
        function out = predict(obj,x)
            ...
            for i=1:mCount
                model = moP(1,i);
                pred = obj.meanFunction(x)+( obj.kernel(obj.X(:,(obj.auxUbic(model)-1)*obj.pts+1:...
    ...
    methods(Access = protected, Static)
        function groups = getPropertyGroupsImpl
            ...
            valueSection = matlab.system.display.Section(...
                'Title','Sample time',...
                'PropertyList',{'timeRate','meanFunction'});
