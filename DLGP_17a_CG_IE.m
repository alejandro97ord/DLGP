classdef DLGP_17a_CG_IE < matlab.System & matlab.system.mixin.Propagates 
    ...
    methods(Access = protected)
        ...
        function out = predict(obj,x)
            moP = zeros(2,900);% line 1: active GPs, line 2: global probability
