...
E = 2; N = 10; Pr = rand(E); P = tril(Pr)*tril(Pr)'; x = rand(E,N);
tic, [V,dVdx,dVdp] = simpleSq(x,P), toc
[n,num,ana] = checkGrad(@simpleSq,1,1,2,{x,P});
[n,num,ana] = checkGrad(@simpleSq,2,1,3,{x,P});
%}
