classdef DLGP_IE_MopMean < matlab.System & matlab.system.mixin.Propagates & matlab.system.mixin.SampleTime & matlab.system.mixin.CustomIcon
    ...
    methods(Access = protected, Static)
        function groups = getPropertyGroupsImpl
            ...
            alwaysSection = matlab.system.display.Section(...
                'Title','','PropertyList',{'ard','outs','pts','N','xSize'});
            ...
            thresholdSection = matlab.system.display.Section(...
                'Title','Parameters',...
                'PropertyList',{'divMethod','wo','meanFunction'});
